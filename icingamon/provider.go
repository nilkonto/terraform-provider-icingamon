...
func Provider() terraform.ResourceProvider {
	return &schema.Provider{
		...
		ResourcesMap: map[string]*schema.Resource{
			"icingamon_host":         resourceIcinga2Host(),
			"icingamon_hostgroup":    resourceIcinga2Hostgroup(),
			"icingamon_checkcommand": resourceIcinga2Checkcommand(),
			"icingamon_service":      resourceIcinga2Service(),
		},
